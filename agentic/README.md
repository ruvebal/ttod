...
| **Leaf skill** | `agentic/skills/<name>/SKILL.md` | a single named workflow with one surface; promote to a pack when a second surface appears | `skills/public-docs-i18n/` |
