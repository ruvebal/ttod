...
That path is complete in the instructor reference. The proposed student baseline keeps the same path but reduces advanced areas to small, working examples that students must meaningfully design and expand.
