...
description: Expectativas públicas de contribución para el código, el contenido, la documentación y las pretensiones de investigación de TTOD.
...
Las contribuciones son bienvenidas cuando se abre el canal de colaboración pertinente. Una contribución debería identificar qué cambió, por qué corresponde, cómo se verificó y qué incertidumbre permanece.
